  ...
  return (
    ...
    >
      ...
      <div className="my-auto py-1 sm:py-2 flex items-center justify-center gap-2 sm:gap-6 md:gap-8 z-10 w-full max-w-5xl mx-auto">
        {/* Wolf Active Face-Up Cards - 2 rows in mobile grid, single row in tablet/desktop */}
        ...
        <div className="flex-shrink-0 flex flex-col items-center justify-center pl-2 sm:pl-4 border-l border-[#313244]/40">
          <div className="relative group">
            ...
            <div className="relative z-10 w-16 h-22 sm:w-20 sm:h-28 md:w-24 md:h-34 lg:w-28 lg:h-40 bg-gradient-to-b from-[#b91c1c] via-[#881337] to-[#450a0a] rounded-xl border border-[#f43f5e]/60 flex flex-col items-center justify-center shadow-[0_8px_30px_rgba(185,28,28,0.4)] p-1.5 sm:p-2 select-none">
              <div className="w-full h-full rounded-lg border border-white/20 bg-black/25 flex flex-col items-center justify-center p-1 sm:p-2 relative overflow-hidden backdrop-blur-xs">
                {/* Wolf Silhouette from Reference Image */}
                <svg
                  viewBox="0 0 200 200"
                  className="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]"
                  fill="currentColor"
                >
